	...
	<div class="container">
				...
				<div class="navbar-inner">
					<div class="container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="phones.jsp">Phones</a></li>
		...
		<div class="container">
			<table id="table2" class="table table-striped table-hover table-bordered">
				...
				<tbody>
					<%
						List<CatalogEntry> entries = Utils.getCatalog("phone");
					...
					<tr>
						...
						<td><h3><%=entry.getName()%> (<%=entry.getYear()%>)</h3><br>
						    ...
						    Manufacturer: <%=entry.getBrand()%><br>
						    Screen Size: <%=entry.getDimension()%>"<br>						    
						    Screen Resolution: <%=entry.getResolution()%><br>
						    Model Year: <%=entry.getYear()%><br>
						    Carrier: <%=entry.getCarrier()%><br>
					    </td>						
					</tr>
					<%
						}

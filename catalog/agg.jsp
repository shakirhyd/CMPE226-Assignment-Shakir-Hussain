	...
	<div class="container">
				...
				<div class="navbar-inner">
					<div class="container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="agg.jsp">Televisions</a></li>
		...
		<div class="container">
			<table id="table2" class="table table-striped table-hover table-bordered">
				...
				<tbody>
					<%
						List<CatalogEntry> entries = Utils.getCatalog("TV");
					...
					<tr>
						...
						<td><h3><%=entry.getName()%> (<%=entry.getYear()%>)</h3><br>
						    ...
						    Size: <%=entry.getDimension()%>"<br>						    
						    Resolution: <%=entry.getResolution()%><br>
